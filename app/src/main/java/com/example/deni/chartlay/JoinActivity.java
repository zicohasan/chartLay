package com.example.deni.chartlay;
...
import com.example.deni.chartlay.adapter.RecyclerViewAdapter;
import com.example.deni.chartlay.api.RegisterAPI;
import com.example.deni.chartlay.model.Charts;
import com.example.deni.chartlay.model.Value;
import com.example.deni.chartlay.model.ValueAccountManager;
import com.example.deni.chartlay.model.ValueBookmarks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rlayout.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                mySound.play(drumID, 1, 1, 1, 0, 1);
                Log.d("ID suara:", String.valueOf(drumID));
                return false;
            }
...
//        t1.stop();
    ...
    public void onChartGestureEnd(MotionEvent me, ChartTouchListener.ChartGesture lastPerformedGesture) {
        ...
        if(me.getY() <=80){ // dungdungdung
            ...
            alertDialogBuilder.setMessage("The number is: "+String.valueOf((int) h.getVal()));
